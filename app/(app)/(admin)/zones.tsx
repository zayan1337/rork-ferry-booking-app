...
export default function ZonesScreen() {
  ...
  const [sortBy, setSortBy] = useState<
    'name' | 'code' | 'order_index' | 'created_at'
  >('order_index');
      ...
      <View style={styles.controlsRow}>
          ...
          <View style={styles.sortControl}>
            ...
            >
              <Text
                style={[
                  styles.sortButtonText,
                  sortBy === 'code' && styles.sortButtonTextActive,
                ]}
              >
                Code
              </Text>
            ...
            >
              <Text
                style={[
                  styles.sortButtonText,
                  sortBy === 'order_index' && styles.sortButtonTextActive,
                ]}
              >
                Order
              </Text>
        ...
        <View style={styles.controlsRight}>
          <Text style={styles.resultsCount}>
            {filteredAndSortedZones.length} zone
            {filteredAndSortedZones.length !== 1 ? 's' : ''}
          </Text>
        </View>
      </View>
