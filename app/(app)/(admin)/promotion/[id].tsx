...
export default function PromotionDetailScreen() {
    ...
    const getDiscountColor = () => {
        if (!promotion || typeof promotion.discount_percentage !== 'number') return colors.primary;
            ...
            >
                ...
                <View style={styles.header}>
                    <View style={styles.headerLeft}>
                        <View style={[styles.promotionIcon, { backgroundColor: discountColor + '15' }]}>
                        ...
                        <View style={styles.headerContent}>
                            ...
                            <View style={styles.promotionMeta}>
                                ...
                                <Text style={[styles.statusText, { color: currentPromotionStatus.color }]}>
                                    {currentPromotionStatus.status}
                                </Text>
                            </View>
                        </View>
                    </View>
                    <View style={[styles.statusBadge, { backgroundColor: currentPromotionStatus.light }]}>
                        <View style={[styles.statusDot, { backgroundColor: currentPromotionStatus.color }]} />
                        <Text style={[styles.statusBadgeText, { color: currentPromotionStatus.color }]}>
                            {currentPromotionStatus.status}
                        </Text>
                    </View>
                </View>
                ...
                <View style={styles.discountSection}>
                    <View style={[styles.discountCard, { backgroundColor: discountColor + '15' }]}>
                        <View style={styles.discountIcon}>
                            <Tag size={24} color={discountColor} />
                        </View>
                        <View style={styles.discountContent}>
                            <Text style={[styles.discountPercentage, { color: discountColor }]}>
                        ...
                        <View style={styles.statsRow}>
                            <View style={styles.statCard}>
                                ...
                                <View style={styles.statCardContent}>
                                    <Text style={styles.statCardValue}>{promotion.discount_percentage}%</Text>
                                    <Text style={styles.statCardLabel}>Discount</Text>
                                </View>
                            </View>

                            <View style={styles.statCard}>
                                <View style={[styles.statCardIcon, { backgroundColor: currentPromotionStatus.light }]}>
                                    {currentPromotionStatus.icon}
                                </View>
                                <View style={styles.statCardContent}>
                                    <Text style={styles.statCardValue}>{currentPromotionStatus.status}</Text>
                            ...
                            <View style={styles.statCard}>
                                ...
                                <View style={styles.statCardContent}>
                                    <Text style={styles.statCardValue}>
                                        {promotion.is_first_time_booking_only ? 'First-time' : 'All Users'}
                                    </Text>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.infoGrid}>
                        <View style={styles.infoRow}>
                            ...
                            <View style={styles.infoItem}>
                                <View style={[styles.infoIcon, { backgroundColor: discountColor + '15' }]}>
                        ...
                        <View style={styles.infoRow}>
                            <View style={styles.infoItem}>
                                <View style={[styles.infoIcon, { backgroundColor: currentPromotionStatus.light }]}>
                                    <Activity size={20} color={currentPromotionStatus.color} />
                                </View>
                                <View style={styles.infoContent}>
                                    <Text style={styles.infoLabel}>Status</Text>
                                    <Text style={[styles.infoValue, { color: currentPromotionStatus.color }]}>
                                        {currentPromotionStatus.status}
                                    </Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.infoItem}>
                                ...
                                <View style={styles.infoContent}>
                                    ...
                                    <Text style={[styles.infoValue, { color: colors.success }]}>
                                        {promotion.is_first_time_booking_only ? 'New Customers Only' : 'All Customers'}
                                    </Text>
                                </View>
                            </View>
                        </View>
                    ...
                    <View style={styles.validityCard}>
                        ...
                        <View style={styles.durationInfo}>
                            ...
                            <Text style={styles.durationText}>
                                Duration: {Math.ceil((new Date(promotion.end_date).getTime() - new Date(promotion.start_date).getTime()) / (1000 * 60 * 60 * 24))} days
                            </Text>
                        </View>
                    </View>
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.systemInfo}>
                        <View style={styles.systemRow}>
                            ...
                            <Text style={styles.systemValue} selectable>{promotion.id}</Text>
                        </View>
                        ...
                        <View style={styles.systemRow}>
                            ...
                            <Text style={[
                                styles.systemValue,
                                { color: promotion.is_active ? colors.success : colors.textSecondary }
                            ]}>
