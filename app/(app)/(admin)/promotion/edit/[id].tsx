...
import { ArrowLeft, Percent, AlertCircle, RefreshCw } from 'lucide-react-native';
import PromotionForm, { PromotionFormData } from '@/components/admin/operations/PromotionForm';
    ...
    const handleSubmit = async (formData: PromotionFormData) => {
        ...
        try {
            const promotionData = {
                ...
                start_date: formData.start_date.includes('T') ? formData.start_date : formData.start_date + 'T00:00:00Z',
                end_date: formData.end_date.includes('T') ? formData.end_date : formData.end_date + 'T23:59:59Z',
            };
            ...
            <View style={styles.container}>
                ...
                <View style={styles.errorContainer}>
                    ...
                    <Text style={styles.errorText}>
                        {error ? 'There was a problem loading the promotion data.' : 'The promotion you\'re looking for doesn\'t exist or has been deleted.'}
                    </Text>
