...
export default function VesselsScreen() {
  ...
  const filteredAndSortedVessels = React.useMemo(() => {
    ...
    if (typeof filterVessels === 'function') {
      filtered = filterVessels(filtered, {
        status: filterActive as
          | 'active'
          | 'maintenance'
          | 'inactive'
          | 'all'
  ...
  const safeVessels = React.useMemo(() => {
    return Array.isArray(filteredAndSortedVessels)
      ? filteredAndSortedVessels.filter(
          ...
          <View style={styles.sortControl}>
            ...
            >
              <Text
                style={[
                  styles.sortButtonText,
                  sortBy === 'seating_capacity' && styles.sortButtonTextActive,
                ]}
              >
                Capacity
              </Text>
          ...
          <View style={styles.filterRow}>
            ...
            >
              <Text
                style={[
                  styles.filterChipText,
                  filterActive === 'maintenance' && styles.filterChipTextActive,
                ]}
              >
                Maintenance
              </Text>
