            ...
            <View style={styles.infoRow}>
              <View style={styles.infoItem}>
                ...
                >
                  <Settings
                    size={20}
                    color={
                      zone.is_active ? colors.success : colors.textSecondary
                    }
                  />
                </View>
                <View style={styles.infoContent}>
              ...
              <View style={styles.infoItem}>
                ...
                <View style={styles.infoContent}>
                  ...
                  <Text style={styles.infoValue}>{zone.order_index}</Text>
                </View>
              </View>
            </View>
          </View>
          ...
          <View style={styles.islandsSummary}>
            <View style={styles.summaryCard}>
              ...
              <Text style={styles.islandsDescription}>
                This zone contains {zone.total_islands || 0} island
                {(zone.total_islands || 0) !== 1 ? 's' : ''}, with{' '}
                {zone.active_islands || 0} active island
                {(zone.active_islands || 0) !== 1 ? 's' : ''} and{' '}
                {zone.total_routes || 0} route
                {(zone.total_routes || 0) !== 1 ? 's' : ''}.
              </Text>
            </View>
