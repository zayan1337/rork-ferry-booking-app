      ...
      >
        ...
        <View style={styles.card}>
          ...
          <View style={styles.inputGroup}>
            ...
            {errors.departureTime && (
              <Text style={styles.fieldErrorText}>{errors.departureTime}</Text>
            )}
          </View>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.inputGroup}>
            ...
            {errors.passengers && (
              <Text style={styles.fieldErrorText}>{errors.passengers}</Text>
            )}
          </View>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.inputGroup}>
            ...
            {errors.totalAmount && (
              <Text style={styles.fieldErrorText}>{errors.totalAmount}</Text>
            )}
          </View>
        </View>
