...
export default function FinanceScreen() {
    ...
    const [activeSection, setActiveSection] = useState<"wallets" | "payments" | "reports" | "transactions">("wallets");
    ...
    const getFilteredTransactions = () => {
        ...
        switch (selectedFilter) {
            case "today":
                return walletTransactions.filter(t => new Date(t.created_at) >= startOfDay);
            case "week":
                return walletTransactions.filter(t => new Date(t.created_at) >= startOfWeek);
            case "month":
                return walletTransactions.filter(t => new Date(t.created_at) >= startOfMonth);
            default:
    ...
    const render3CardGrid = (cards: React.ReactNode[]) => (
        <View style={[styles.statsGrid, styles.statsGrid3SingleRow]}>
            <View style={styles.statsRowSingle3}>
                {cards}
            </View>
        </View>
    );
    ...
    const renderSectionSelector = () => (
        <View style={styles.sectionSelector}>
            {[
                ...
                { key: "transactions", label: "Transactions", icon: Activity, permission: canViewWallets() },
                { key: "payments", label: "Payments", icon: CreditCard, permission: canViewPayments() },
                { key: "reports", label: "Reports", icon: BarChart3, permission: canViewPayments() },
    ...
    const renderWallets = () => {
        ...
        return (
            <View style={styles.sectionContent}>
                ...
                {/* Wallet Statistics */}
                {render3CardGrid([
                    <View key="active-wallets" style={[styles.statCard3Grid, isTablet && styles.statCard3GridTablet]}>
                    ...
                    <View key="total-balance" style={[styles.statCard3Grid, isTablet && styles.statCard3GridTablet]}>
                        <View style={[styles.statIcon, { backgroundColor: "#34C759" + "15" }]}>
                    ...
                    <View key="today-txns" style={[styles.statCard3Grid, isTablet && styles.statCard3GridTablet]}>
                ...
                <View style={styles.contentSection}>
                        ...
                        <View style={styles.walletSectionHeader}>
                            ...
                            <View style={styles.walletSectionStats}>
                                <View style={styles.walletStatItem}>
                                    <Text style={styles.walletStatValue}>MVR {totalWalletBalance.toFixed(0)}</Text>
                                    <Text style={styles.walletStatLabel}>Total Balance</Text>
                                </View>
                                <View style={styles.walletStatDivider} />
                                <View style={styles.walletStatItem}>
                                    <Text style={styles.walletStatValue}>{todayTransactions}</Text>
                                    ...
                                    <View style={styles.walletItemContent}>
                                        ...
                                        <View style={styles.walletItemHeader}>
                                            <View style={styles.walletUserInfo}>
                                                ...
                                                { backgroundColor: wallet.is_active ? colors.primary + "20" : colors.textSecondary + "20" }
                                                ]}>
                                                    <Wallet size={20} color={wallet.is_active ? colors.primary : colors.textSecondary} />
                                                </View>
                                                <View style={styles.walletUserDetails}>
                                                    ...
                                                    <Text style={styles.walletUserId}>ID: {wallet.user_id.slice(-8)}</Text>
                                                </View>
                                            </View>
                                            <View style={styles.walletStatusContainer}>
                                                <View style={[styles.statusBadge,
                                                wallet.is_active ? styles.statusActive : styles.statusInactive
                                                ]}>
                                                    <Text style={[styles.statusText,
                                                    wallet.is_active ? styles.statusTextActive : styles.statusTextInactive
                                                    ]}>
                                        ...
                                        <View style={styles.walletBalanceSection}>
                                            ...
                                            <View style={styles.walletBalanceMetrics}>
                                                <View style={styles.walletMetricItem}>
                                                    ...
                                                    <Text style={styles.walletMetricLabel}>Transactions</Text>
                                                </View>
                                                <View style={styles.walletMetricDivider} />
                                                <View style={styles.walletMetricItem}>
                                                    <Text style={styles.walletMetricValue}>
                                                        {Math.floor((new Date().getTime() - new Date(wallet.created_at).getTime()) / (1000 * 60 * 60 * 24))}d
                                                    </Text>
                                        ...
                                        <View style={styles.walletFinancialSummary}>
                                            <View style={styles.walletFinancialItem}>
                                                <View style={styles.walletFinancialHeader}>
                                                    ...
                                                    <Text style={styles.walletFinancialLabel}>Total Credits</Text>
                                                </View>
                                                <Text style={[styles.walletFinancialValue, { color: colors.success }]}>
                                            ...
                                            <View style={styles.walletFinancialItem}>
                                                <View style={styles.walletFinancialHeader}>
                                                    ...
                                                    <Text style={styles.walletFinancialLabel}>Total Debits</Text>
                                                </View>
                                                <Text style={[styles.walletFinancialValue, { color: colors.danger }]}>
                                        ...
                                        <View style={styles.walletItemActions}>
                                            <View style={styles.walletLastActivity}>
                                                ...
                                                <Text style={styles.walletLastActivityText}>
                                                    Last updated: {new Date(wallet.updated_at || wallet.created_at).toLocaleDateString()}
                                                </Text>
                                            </View>
                                            <View style={styles.walletActionButtons}>
                                                {canManageWallets() && (
                                                    ...
                                                    >
                                                        ...
                                                        <Text style={styles.walletActionText}>Add Credit</Text>
                                                    </TouchableOpacity>
                                                )}
                                                <TouchableOpacity
                                                ...
                                                >
                                                    ...
                                                    <Text style={styles.walletActionTextSecondary}>View Details</Text>
                                                </TouchableOpacity>
                                            </View>
                                        </View>
                                    </View>
                    ...
                    {wallets.length > (isTablet ? 15 : 10) && (
                        ...
                        >
                            <Text style={styles.viewAllText}>View All Wallets ({wallets.length})</Text>
    ...
    const renderTransactions = () => {
        ...
        return (
            <View style={styles.sectionContent}>
                ...
                {/* Transaction Stats */}
                {render3CardGrid([
                    <View key="credits" style={[styles.statCard3Grid, isTablet && styles.statCard3GridTablet]}>
                        <View style={[styles.statIcon, { backgroundColor: colors.success + "15" }]}>
                            <ArrowUpRight size={20} color={colors.success} />
                        </View>
                        <View style={styles.statInfo}>
                            <Text style={[styles.statValue, { color: colors.success }]}>
                                {filteredTransactions.filter(t => t.transaction_type === "credit").length}
                            </Text>
                            <Text style={styles.statLabel}>Credits</Text>
                        </View>
                    </View>,
                    <View key="debits" style={[styles.statCard3Grid, isTablet && styles.statCard3GridTablet]}>
                        <View style={[styles.statIcon, { backgroundColor: colors.danger + "15" }]}>
                            <ArrowDownLeft size={20} color={colors.danger} />
                        </View>
                        <View style={styles.statInfo}>
                            <Text style={[styles.statValue, { color: colors.danger }]}>
                                {filteredTransactions.filter(t => t.transaction_type === "debit").length}
                            </Text>
                            <Text style={styles.statLabel}>Debits</Text>
                        </View>
                    </View>,
                    <View key="total-volume" style={[styles.statCard3Grid, isTablet && styles.statCard3GridTablet]}>
                        <View style={styles.statIcon}>
                            <DollarSign size={20} color={colors.primary} />
                        </View>
                        <View style={styles.statInfo}>
                            <Text style={styles.statValue}>
                                MVR {filteredTransactions.reduce((sum, t) => sum + t.amount, 0).toFixed(0)}
                            </Text>
                ...
                <View style={styles.contentSection}>
                    <View style={styles.itemsList}>
                        {filteredTransactions.slice(0, isTablet ? 20 : 15).map((transaction) => (
                            <View key={transaction.id} style={styles.listItem}>
                                <View style={styles.itemContent}>
                                    <View style={styles.itemHeader}>
                                        <View style={[
                                            styles.transactionTypeIndicator,
                                            transaction.transaction_type === "credit" ? styles.creditIndicator : styles.debitIndicator
                                        ]}>
                                        ...
                                        <View style={styles.transactionInfo}>
                                            <Text style={styles.itemTitle}>{transaction.user_name}</Text>
    ...
    const renderPayments = () => {
        ...
        return (
            <View style={styles.sectionContent}>
                ...
                {render3CardGrid([
                    <View key="completed" style={[styles.statCard3Grid, isTablet && styles.statCard3GridTablet]}>
                        <View style={[styles.statIcon, { backgroundColor: colors.success + "15" }]}>
                    ...
                    <View key="pending" style={[styles.statCard3Grid, isTablet && styles.statCard3GridTablet]}>
                    ...
                    <View key="failed" style={[styles.statCard3Grid, isTablet && styles.statCard3GridTablet]}>
                        <View style={[styles.statIcon, { backgroundColor: colors.danger + "15" }]}>
                    ...
                    <View style={styles.dataSection}>
                        ...
                        <View style={styles.enhancedTransactionsList}>
                            {[
                                ...
                                <TouchableOpacity key={transaction.id} style={styles.enhancedTransactionItem}>
                                    <View style={styles.transactionMainContent}>
                                        ...
                                        <View style={styles.customerInfo}>
                                            <View style={styles.customerDetails}>
                                                ...
                                                <Text style={styles.customerContact}>{transaction.email}</Text>
                                                <Text style={styles.customerContact}>{transaction.phone}</Text>
                                            </View>
                                            <View style={styles.transactionDetails}>
                                                <Text style={styles.routeInfo}>{transaction.route}</Text>
                                                <Text style={styles.bookingInfo}>Booking: {transaction.bookingId}</Text>
                                            </View>
                                        </View>
                                        ...
                                        <View style={styles.paymentMethodInfo}>
                                            <View style={styles.methodDetails}>
                                                ...
                                                <Text style={styles.gatewayInfo}>{transaction.gateway}</Text>
                                            </View>
                                        ...
                                        <View style={styles.financialBreakdown}>
                                            <View style={styles.amountRow}>
                                                ...
                                                <Text style={styles.amountValue}>MVR {transaction.amount.toFixed(2)}</Text>
                                            </View>
                                            {transaction.fee > 0 && (
                                                <View style={styles.amountRow}>
                                                    <Text style={styles.feeLabel}>Processing Fee:</Text>
                                                    <Text style={styles.feeValue}>MVR {transaction.fee.toFixed(2)}</Text>
                                                </View>
                                            )}
                                            <View style={styles.totalRow}>
                                                <Text style={styles.totalLabel}>Net Amount:</Text>
                                                <Text style={styles.totalValue}>MVR {transaction.netAmount.toFixed(2)}</Text>
                                            </View>
                                        </View>
                                        ...
                                        <View style={styles.transactionMetadata}>
                                            <View style={styles.metadataItem}>
                                                ...
                                                <Text style={styles.metadataText}>{transaction.date}</Text>
                                            </View>
                    ...
                    <View style={styles.dataSection}>
                        ...
                        <View style={styles.statsGrid}>
                            <StatCard
                                ...
                                value={`MVR ${walletTransactions.length > 0 ?
                                    (walletTransactions.reduce((sum, t) => sum + t.amount, 0) / walletTransactions.length).toFixed(2) :
                                    "0.00"
                                    }`}
                                subtitle="per transaction"
                                icon={<DollarSign size={isTablet ? 20 : 18} color={colors.primary} />}
                                size={isTablet ? "large" : "medium"}
                            />
                            <StatCard
                                title="Payment Success Rate"
                                value={`${dashboardStats.paymentStatus.completed > 0 ?
                                    Math.round((dashboardStats.paymentStatus.completed /
                                        (dashboardStats.paymentStatus.completed + dashboardStats.paymentStatus.failed)) * 100) :
                                    0
                                    }%`}
                    ...
                    <View style={styles.dataSection}>
                        ...
                        <View style={styles.actionGrid}>
                            <TouchableOpacity style={styles.actionCard}>
                                ...
                                <Text style={styles.actionSubtitle}>Download detailed transaction reports</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={styles.actionCard}>
                                <View style={[styles.actionIcon, { backgroundColor: "#34C759" + "15" }]}>
                                    <BarChart3 size={24} color="#34C759" />
                                </View>
                                <Text style={styles.actionTitle}>Revenue Analytics</Text>
                                <Text style={styles.actionSubtitle}>View comprehensive revenue insights</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={styles.actionCard}>
                                ...
                                <Text style={styles.actionSubtitle}>Review wallet activities and balances</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={styles.actionCard}>
                                <View style={[styles.actionIcon, { backgroundColor: "#8E44AD" + "15" }]}>
                                    <RefreshCw size={24} color="#8E44AD" />
                                </View>
                                <Text style={styles.actionTitle}>Reconciliation</Text>
                                <Text style={styles.actionSubtitle}>Balance payment gateways</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
