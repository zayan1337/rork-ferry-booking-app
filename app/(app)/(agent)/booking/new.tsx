...
import { generateBookingSuccessMessage, validateBookingStep } from "@/utils/bookingFormUtils";
      ...
      case 6:
        return (
          <PaymentStep
            ...
            onPaymentMethodChange={(method) => setPaymentMethod(method as 'credit' | 'gateway' | 'free')}
