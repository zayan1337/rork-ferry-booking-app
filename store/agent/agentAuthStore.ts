...
import { fetchAgentProfileWithStats, createFallbackAgent } from '@/utils/agentUtils';
...
interface AgentAuthState {
    ...
    getAgentProfile: (agentId: string) => Promise<{ agent: Agent; stats: any } | null>;
        ...
        (set, get) => ({
            ...
            initializeFromAuthUser: async (authUser: any) => {
                ...
                try {
                    ...
                    if (profileData) {
                        ...
                        const translations = await get().getTranslations(userLanguage, 'agent_module');
            ...
            setLanguage: async (languageCode: string) => {
                try {
                    ...
                    const translations = await get().getTranslations(languageCode, 'agent_module');
