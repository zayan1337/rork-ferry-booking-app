...
export const useTripManagement = (
  ...
  const updateTrip = useCallback(
    async (id: string, data: Partial<TripFormData>) => {
  ...
  const changeStatus = useCallback(
    async (id: string, status: Trip['status'], reason?: string) => {
  ...
  const loadTripsByStatus = useCallback(
    async (status: string) => {
  ...
  const loadTripsByRoute = useCallback(
  ...
  const loadTripsByVessel = useCallback(
  ...
  const loadTripsByDate = useCallback(
    async (date: string) => {
  ...
  const loadTripPassengers = useCallback(
    async (tripId: string) => {
  ...
  const getTripWithDetails = useCallback(
    async (id: string) => {
