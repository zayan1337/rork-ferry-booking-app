...
export interface UseIslandManagementReturn extends BaseManagementHook<Island, IslandFormData, IslandStats> {
...
export const useIslandManagement = (
    ...
    const getIslandWithDetails = useCallback((id: string): IslandWithDetails | undefined => {
    ...
    const loadIslandsByZone = useCallback(async (zoneId: string) => {
        try {
    ...
    const createIsland = useCallback(async (data: IslandFormData) => {
        try {
    ...
    const updateIsland = useCallback(async (id: string, data: Partial<IslandFormData>) => {
        try {
    ...
    const removeIsland = useCallback(async (id: string) => {
        try {
    ...
    const validateData = useCallback((data: Partial<IslandFormData>) => {
    ...
    const handleSetFilters = useCallback((newFilters: Partial<IslandFilters>) => {
