...
export interface Permission {
    ...
    name: string;
    description: string;
    category: "users" | "operations" | "bookings" | "finance" | "communications" | "settings" | "reports";
...
export interface UserActivity {
    id: string;
    user_id: string;
    activity_type: "login" | "logout" | "booking" | "payment" | "profile_update" | "password_change" | "permission_change";
    description: string;
...
export interface PermissionFilters {
    category?: "all" | "users" | "operations" | "bookings" | "finance" | "communications" | "settings" | "reports";
...
export interface UserActivityFilters {
    user_id?: string;
    activity_type?: "all" | "login" | "logout" | "booking" | "payment" | "profile_update" | "password_change" | "permission_change";
    date_range?: {
        from: string;
        to: string;
    };
...
// Sort Types
export type UserSortField = "name" | "email" | "role" | "status" | "created_at" | "last_login" | "total_bookings" | "total_spent";
export type PermissionSortField = "name" | "category" | "level" | "created_at";
export type RoleSortField = "name" | "created_at";
export type UserActivitySortField = "created_at" | "activity_type" | "user_name";
...
export interface UserManagementOverview {
    ...
    security_alerts: {
        type: "suspicious_login" | "multiple_failed_attempts" | "password_reset" | "permission_escalation";
        user_id: string;
        user_name: string;
        description: string;
...
export interface BulkUserOperation {
    type: "status_change" | "role_change" | "permission_grant" | "permission_revoke" | "delete" | "export";
    user_ids: string[];
    params?: {
        status?: "active" | "inactive" | "suspended" | "banned";
        role_id?: string;
