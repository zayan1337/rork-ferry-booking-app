 ...
 */
export const getClientDisplayName = (clientName: string | undefined, clients: Client[] | undefined): string => {
 ...
 */
export const getClientByNameOrEmail = (clientName: string | undefined, clients: Client[] | undefined): Client | undefined => {
