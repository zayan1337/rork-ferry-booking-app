...
interface AgentIslandDateStepProps {
  onFindTrips: () => void;
}

export default function AgentIslandDateStep({
  onFindTrips,
}: AgentIslandDateStepProps) {
  ...
  const validateAndProceed = () => {
    ...
    if (currentBooking.tripType === AGENT_TRIP_TYPES.ROUND_TRIP) {
      ...
      <View style={styles.tripTypeContainer}>
        <Pressable
          style={[
            ...
            currentBooking.tripType === AGENT_TRIP_TYPES.ONE_WAY &&
              styles.tripTypeButtonActive,
          ]}
          onPress={() => {
            setTripType(AGENT_TRIP_TYPES.ONE_WAY);
        ...
        <Pressable
          ...
          onPress={() => {
            setTripType(AGENT_TRIP_TYPES.ROUND_TRIP);
            if (errors.tripType) setErrors({ ...errors, tripType: '' });
          }}
        >
          <Text
