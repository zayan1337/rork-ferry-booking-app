...
import { Calendar, MapPin, User, DollarSign, CreditCard, Ship, Clock, ArrowRightLeft, CheckCircle2, QrCode } from "lucide-react-native";
...
const AgentBookingCard = React.memo<AgentBookingCardProps>(({ booking, onPress }) => {
    ...
    const isRoundTrip = booking.tripType === 'round_trip' || booking.isRoundTrip;
                ...
                <View style={styles.header}>
                    <View style={styles.routeContainer}>
                        <View style={styles.routeInfo}>
                            <Text style={[styles.routeText, bookingInactive && styles.inactiveText]}>
                    ...
                    <View style={[styles.statusBadge, { backgroundColor: getStatusColor(booking.status, bookingExpired) }]}>
                ...
                <View style={styles.tripDetails}>
                    <View style={styles.dateTimeRow}>
                        <View style={styles.dateTimeItem}>
                            ...
                            <Text style={[styles.dateTimeText, bookingExpired && styles.expiredText]}>
                ...
                <View style={styles.additionalInfo}>
                    <View style={styles.additionalInfoLeft}>
                        <View style={styles.paymentMethodContainer}>
                            <CreditCard size={12} color={getPaymentMethodColor(booking.paymentMethod)} />
                            <Text style={[styles.paymentMethodText, { color: getPaymentMethodColor(booking.paymentMethod) }]}>
                    ...
                    {booking.commission > 0 && (
                        <View style={styles.commissionContainer}>
                            ...
                            <Text style={styles.commissionAmount}>{formatCurrency(booking.commission)}</Text>
                        </View>
                    )}
                </View>
                    ...
                    <View style={styles.priceInfo}>
                        ...
                        {hasDiscount && (
                            <Text style={styles.discountText}>
                                Save {formatCurrency(booking.totalAmount - booking.discountedAmount)}
                            </Text>
                        )}
                    </View>
                </View>
