...
export const SkeletonAgentBookingCard: React.FC<{ delay?: number }> = ({ delay = 0 }) => (
    <SkeletonCard height={140} style={styles.bookingCard}>
        ...
        <View style={styles.bookingInfoRow}>
            <View style={styles.bookingInfoItem}>
                ...
                <Skeleton width={120} height={14} style={{ marginLeft: 6 }} delay={delay + 150} />
            </View>
            <View style={styles.bookingInfoItem}>
                <Skeleton width={16} height={16} borderRadius={8} delay={delay + 200} />
                <Skeleton width={80} height={14} style={{ marginLeft: 6 }} delay={delay + 250} />
            </View>
        </View>
        ...
        <View style={styles.bookingFooter}>
            <View style={styles.bookingClientInfo}>
                ...
                <Skeleton width="50%" height={12} style={{ marginTop: 2 }} delay={delay + 350} />
            </View>
            <View style={styles.bookingPriceInfo}>
                <Skeleton width={60} height={18} delay={delay + 400} />
                <Skeleton width={50} height={14} style={{ marginTop: 2 }} delay={delay + 450} />
            </View>
        </View>
    </SkeletonCard>
);
...
export const SkeletonClientCard: React.FC<{ delay?: number }> = ({ delay = 0 }) => (
    <SkeletonCard height={120} style={styles.clientCard}>
        ...
        <View style={styles.clientHeader}>
            ...
            <View style={styles.clientInfo}>
                <View style={styles.clientNameRow}>
                    ...
                    <Skeleton width={60} height={16} borderRadius={8} delay={delay + 100} />
                </View>
                <Skeleton width="80%" height={14} style={{ marginTop: 2 }} delay={delay + 150} />
            </View>
            <View style={styles.clientBookingsInfo}>
                <Skeleton width={40} height={24} borderRadius={12} delay={delay + 200} />
                <Skeleton width={30} height={16} borderRadius={8} style={{ marginTop: 4 }} delay={delay + 250} />
            </View>
        </View>
        ...
        <View style={styles.clientContactInfo}>
            <View style={styles.clientContactRow}>
                ...
                <Skeleton width="40%" height={12} style={{ marginLeft: 6 }} delay={delay + 350} />
            </View>
            <View style={styles.clientContactRow}>
                <Skeleton width={14} height={14} borderRadius={7} delay={delay + 400} />
                <Skeleton width="50%" height={12} style={{ marginLeft: 6 }} delay={delay + 450} />
            </View>
        </View>
    </SkeletonCard>
);
...
export const SkeletonSearchHeader: React.FC<{ delay?: number; showAddButton?: boolean }> = ({ 
    delay = 0, 
    showAddButton = true 
}) => (
    <View style={styles.searchHeaderContainer}>
        ...
        {showAddButton && (
            <Skeleton width={40} height={40} borderRadius={8} style={{ marginLeft: 12 }} delay={delay + 50} />
        )}
    </View>
);

// Tab Navigation Skeleton
export const SkeletonTabNavigation: React.FC<{ tabCount?: number; delay?: number }> = ({ 
    tabCount = 4, 
    delay = 0 
}) => (
...
export const SkeletonCreditSummary: React.FC<{ delay?: number }> = ({ delay = 0 }) => (
    <SkeletonCard height={160} style={{ marginBottom: 16 }}>
        ...
        <View style={styles.creditBalanceContainer}>
            ...
            <View style={styles.creditBalanceText}>
                ...
                <Skeleton width={100} height={24} style={{ marginTop: 4 }} delay={delay + 100} />
            </View>
        </View>
        ...
        <View style={styles.creditLimitContainer}>
            ...
            <Skeleton width={150} height={12} style={{ marginTop: 8, alignSelf: 'flex-end' }} delay={delay + 200} />
        </View>

        {/* Request Credit Button */}
        <Skeleton width="100%" height={40} borderRadius={8} style={{ marginTop: 16 }} delay={delay + 250} />
    </SkeletonCard>
);

// Transaction Summary Card Skeleton  
export const SkeletonTransactionSummary: React.FC<{ delay?: number }> = ({ delay = 0 }) => (
    <SkeletonCard height={80} style={styles.transactionSummaryCard}>
        <View style={styles.transactionSummaryItem}>
            ...
            <View style={{ marginLeft: 12 }}>
                ...
                <Skeleton width={60} height={16} style={{ marginTop: 4 }} delay={delay + 100} />
            </View>
        </View>
        ...
        <View style={styles.transactionSummaryItem}>
            ...
            <View style={{ marginLeft: 12 }}>
                ...
                <Skeleton width={60} height={16} style={{ marginTop: 4 }} delay={delay + 250} />
            </View>
        </View>
    </SkeletonCard>
);
...
export const SkeletonClientStats: React.FC<{ delay?: number }> = ({ delay = 0 }) => (
    <SkeletonCard height={60} style={styles.clientStatsCard}>
        <View style={styles.clientStatsRow}>
            <View style={styles.clientStatItem}>
                ...
                <Skeleton width={60} height={12} style={{ marginTop: 4 }} delay={delay + 50} />
            </View>
            <View style={styles.clientStatDivider} />
            <View style={styles.clientStatItem}>
                <Skeleton width={30} height={20} delay={delay + 100} />
                <Skeleton width={80} height={12} style={{ marginTop: 4 }} delay={delay + 150} />
            </View>
            <View style={styles.clientStatDivider} />
            <View style={styles.clientStatItem}>
                <Skeleton width={30} height={20} delay={delay + 200} />
                <Skeleton width={70} height={12} style={{ marginTop: 4 }} delay={delay + 250} />
            </View>
        </View>
    </SkeletonCard>
);
...
export const SkeletonAgentInfoSection: React.FC<{ delay?: number }> = ({ delay = 0 }) => (
    <SkeletonCard height={120}>
        <View style={styles.agentInfoHeader}>
            <SkeletonText lines={1} lineHeight={16} lastLineWidth="50%" delay={delay + 50} />
            ...
            <View style={styles.agentInfoRow}>
                {Array.from({ length: 3 }).map((_, index) => (
                    <View key={index} style={styles.agentInfoItem}>
                        <SkeletonText lines={1} lineHeight={12} lastLineWidth="70%" delay={delay + 150 + (index * 50)} />
                        <SkeletonText lines={1} lineHeight={16} lastLineWidth="80%" delay={delay + 200 + (index * 50)} />
                    </View>
                ))}
            </View>
        </View>
...
export const SkeletonStatsSection: React.FC<{ delay?: number }> = ({ delay = 0 }) => (
...
export const SkeletonRecentBookingsList: React.FC<{ count?: number; delay?: number }> = ({ count = 3, delay = 0 }) => (
    <View>
        {Array.from({ length: count }).map((_, index) => (
...
export const SkeletonBookingsList: React.FC<{ count?: number; delay?: number }> = ({ count = 6, delay = 0 }) => (
...
export const SkeletonClientsList: React.FC<{ count?: number; delay?: number }> = ({ count = 7, delay = 0 }) => (
...
export const SkeletonCreditTransactionsList: React.FC<{ count?: number; delay?: number }> = ({ count = 8, delay = 0 }) => (
