...
export const SkeletonBookingsPage: React.FC<{ bookingCount?: number }> = ({ bookingCount = 5 }) => (
    <View style={styles.pageContainer}>
        ...
        <ScrollView style={styles.listContainer} contentContainerStyle={styles.listContent}>
            {Array.from({ length: bookingCount }).map((_, index) => (
                <SkeletonAgentBookingCard key={`booking-${index}`} delay={200 + (index * 100)} />
            ))}
        </ScrollView>
    </View>
);
...
export const SkeletonClientsPage: React.FC<{ clientCount?: number }> = ({ clientCount = 6 }) => (
    <View style={styles.pageContainer}>
        {/* Search Header */}
        <SkeletonSearchHeader showAddButton={true} />
...
export const SkeletonCreditPage: React.FC<{ transactionCount?: number }> = ({ transactionCount = 8 }) => (
    <View style={styles.pageContainer}>
        {/* Credit Summary */}
        ...
        <View style={styles.sectionHeaderContainer}>
            <View style={styles.sectionHeader}>
                <View style={styles.sectionTitleContainer}>
                    <SkeletonText lines={1} lineHeight={18} lastLineWidth="60%" delay={200} />
                </View>
            </View>
        </View>
        ...
        <ScrollView style={styles.listContainer} contentContainerStyle={styles.listContent}>
            {Array.from({ length: transactionCount }).map((_, index) => (
                <SkeletonCreditTransactionCard key={`transaction-${index}`} delay={250 + (index * 80)} />
            ))}
        </ScrollView>
    </View>
);
...
export const SkeletonDashboardPage: React.FC<{ recentBookingCount?: number }> = ({ recentBookingCount = 3 }) => (
    <ScrollView style={styles.pageContainer} contentContainerStyle={styles.dashboardContent}>
        ...
        <View style={styles.sectionContainer}>
            <View style={styles.sectionTitleContainer}>
                <SkeletonText lines={1} lineHeight={18} lastLineWidth="50%" delay={150} />
            </View>
            <ScrollView
                horizontal
        ...
        <View style={styles.sectionContainer}>
            <View style={styles.recentBookingsHeader}>
                <View style={styles.sectionTitleContainer}>
                    <SkeletonText lines={1} lineHeight={18} lastLineWidth="40%" delay={200} />
                </View>
                <Skeleton width={80} height={24} borderRadius={4} delay={250} />
            </View>
            {Array.from({ length: recentBookingCount }).map((_, index) => (
                <SkeletonAgentBookingCard key={`recent-booking-${index}`} delay={300 + (index * 100)} />
            ))}
        </View>
    </ScrollView>
);
...
export const SkeletonProfilePage: React.FC = () => (
    <ScrollView style={styles.pageContainer} contentContainerStyle={styles.profileContent}>
        {/* Profile Header */}
        <View style={styles.profileHeader}>
            <Skeleton width={80} height={80} borderRadius={40} delay={0} />
            <View style={styles.profileHeaderText}>
                <SkeletonText lines={1} lineHeight={20} lastLineWidth="70%" delay={50} />
                <SkeletonText lines={1} lineHeight={14} lastLineWidth="60%" delay={100} />
            </View>
        </View>
        ...
        <View style={styles.profileInfoContainer}>
            <SkeletonCard height={120} style={styles.profileInfoCard}>
                <View style={styles.profileCardHeader}>
                    <SkeletonText lines={1} lineHeight={16} lastLineWidth="40%" delay={150} />
                </View>
            ...
            <SkeletonCard height={100} style={styles.profileInfoCard}>
                <View style={styles.profileCardHeader}>
                    <SkeletonText lines={1} lineHeight={16} lastLineWidth="35%" delay={250} />
                </View>
                <View style={styles.profileCardContent}>
            ...
            <SkeletonCard height={140} style={styles.profileInfoCard}>
                <View style={styles.profileCardHeader}>
                    <SkeletonText lines={1} lineHeight={16} lastLineWidth="45%" delay={350} />
                </View>
                <View style={styles.profileCardContent}>
        ...
        <View style={styles.profileActions}>
            ...
            <Skeleton width="100%" height={44} borderRadius={8} style={{ marginTop: 12 }} delay={500} />
        </View>
    </ScrollView>
);
