...
const FAQTab: React.FC<FAQTabProps> = ({ isActive, searchQuery = '' }) => {
      ...
      <View style={styles.tabToggleContainer}>
        ...
        >
          <Folder
            size={16}
            color={
              activeTab === 'categories' ? colors.primary : colors.textSecondary
            }
          />
          <Text
            style={[
  ...
  const renderItem = ({
    ...
    item: FAQ | (FAQCategory & { faq_count: number; active_faq_count: number });
  }) => {
    if (activeTab === 'categories') {
      ...
      return <FAQItem faq={faq} onPress={handleFAQPress} />;
    }
  };
