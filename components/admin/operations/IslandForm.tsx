...
export default function IslandForm({
  ...
  const { data: zones, fetchAll: fetchZones } = useZoneStore();
                ...
                <View style={styles.zoneDescriptionContent}>
                  ...
                  >
                    {selectedZone.description ||
                      'Zone for ferry operations and island management'}
                  </Text>
                  {selectedZone.total_islands !== undefined && (
                    ...
                    >
                      {selectedZone.total_islands} island(s) •{' '}
                      {selectedZone.total_routes || 0} route(s)
                    </Text>
                  )}
                </View>
              </View>
