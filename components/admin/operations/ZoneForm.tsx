...
export default function ZoneForm({
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.name.trim()) {
      ...
      errors.name =
        'Zone name can only contain letters, numbers, spaces, dots, and dashes';
    }
    ...
    if (!formData.code.trim()) {
      ...
      errors.code =
        'Zone code can only contain uppercase letters, numbers, underscores, and dashes';
    }

    // Check for duplicates
    if (zones) {
      const existingZoneWithSameName = zones.find(
        zone =>
      ...
      const existingZoneWithSameCode = zones.find(
        zone =>
    ...
    const orderValidation = validateZoneOrder(
        ...
        <View style={styles.section}>
          ...
          <View style={styles.formGroup}>
            <TextInput
              ...
              value={formData.code}
              onChangeText={text =>
                setFormData(prev => ({ ...prev, code: text.toUpperCase() }))
              }
            ...
            <View style={styles.codeDescription}>
              ...
              <Text style={styles.codeDescriptionText}>
                Unique code used to identify this zone (uppercase letters,
