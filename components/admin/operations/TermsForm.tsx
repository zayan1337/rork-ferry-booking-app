...
const TermsForm: React.FC<TermsFormProps> = ({
  ...
  const { createTerms, updateTerms, loading, validateTermsData } =
  ...
  const [formData, setFormData] = useState<TermsFormData>({
    ...
    effective_date:
      terms?.effective_date || new Date().toISOString().split('T')[0],
        ...
        <View style={styles.infoContainer}>
          ...
          <View style={styles.infoContent}>
            ...
            <Text style={styles.infoText}>
              Make sure to review all terms carefully before publishing. Once
              active, these terms will be visible to all users and legally
              binding.
            </Text>
          </View>
        </View>
