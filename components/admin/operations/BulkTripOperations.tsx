...
export default function BulkTripOperations({
        ...
        switch (operation) {
            ...
            case 'delay':
                if (!data.delayMinutes || isNaN(parseInt(data.delayMinutes))) {
                    Alert.alert('Error', 'Please provide valid delay duration in minutes');
                    return false;
                }
    ...
    const executeOperation = async () => {
        ...
        try {
            ...
            Alert.alert('Error', 'Failed to execute bulk operation. Please try again.');
        } finally {
                ...
                return (
                    <View style={styles.formContainer}>
                        ...
                        <Input
                            ...
                            onChangeText={(text) => setOperationData(prev => ({ ...prev, reason: text }))}
                            multiline
                            numberOfLines={3}
                        />
                    </View>
                ...
                return (
                    <View style={styles.formContainer}>
                        ...
                        <Input
                            ...
                            onChangeText={(text) => setOperationData(prev => ({ ...prev, delayMinutes: text }))}
                        ...
                        <Input
                            ...
                            onChangeText={(text) => setOperationData(prev => ({ ...prev, delayReason: text }))}
                            multiline
                            numberOfLines={2}
                        />
                    </View>
                ...
                return (
                    <View style={styles.formContainer}>
                        ...
                        <Input
                            ...
                            onChangeText={(text) => setOperationData(prev => ({ ...prev, newTime: text }))}
                        />
                        ...
                        <Input
                            ...
                            onChangeText={(text) => setOperationData(prev => ({ ...prev, rescheduleReason: text }))}
                            multiline
                            numberOfLines={2}
                        />
                    </View>
                ...
                return (
                    <View style={styles.formContainer}>
                        ...
                        <Input
                            ...
                            onChangeText={(text) => setOperationData(prev => ({ ...prev, fareMultiplier: text }))}
                ...
                return (
                    <View style={styles.formContainer}>
                        ...
                        <Dropdown
                            ...
                            onValueChange={(value) => setOperationData(prev => ({ ...prev, status: value }))}
                            items={statusOptions}
                        />
                    </View>
                );
                ...
                <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
                    <View style={styles.summaryContainer}>
                        <Text style={styles.summaryText}>
                            Selected {selectedTrips.length} trip{selectedTrips.length !== 1 ? 's' : ''}
                        </Text>
                            ...
                            <View style={styles.tripsList}>
                                ...
                                {selectedTrips.length > 5 && (
                                    <View style={styles.tripCard}>
                                        <Text style={styles.tripRoute}>+{selectedTrips.length - 5}</Text>
                            ...
                            {operations.map((operation) => (
                                <TouchableOpacity
                                    ...
                                    style={[
                                        ...
                                        selectedOperation === operation.type && styles.operationCardSelected
                                    ]}
