...
export default function RouteDetails({
    ...
    const stats = [
        ...
        },
        {
            ...
            subtitle: 'Last 30 days',
            icon: <Users size={20} color={getUtilizationColor(route.average_occupancy_30d || 0)} />,
            trend: route.average_occupancy_30d && route.average_occupancy_30d > 70 ? '+' : '',
        },
        {
            title: 'Performance',
            ...
            trend: route.popularity_score && route.popularity_score > 80 ? 'up' : 'neutral',
        },
    ];
                ...
                <View style={styles.infoGrid}>
                    <View style={styles.infoItem}>
                        ...
                        <View style={styles.infoContent}>
                            ...
                            <Text style={styles.infoValue}>{formatRouteDistance(route.distance)}</Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.infoItem}>
                        ...
                        <View style={styles.infoContent}>
                            ...
                            <Text style={styles.infoValue}>{formatRouteDuration(route.duration)}</Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.infoItem}>
                        ...
                        <View style={styles.infoContent}>
                            ...
                            <Text style={styles.infoValue}>{formatCurrency(route.base_fare)}</Text>
                        </View>
                    </View>
                        ...
                        <View style={styles.analyticsContent}>
                            ...
                            <Text style={styles.analyticsValue}>
                                {route.average_occupancy_30d && route.average_occupancy_30d > 80
                                    ? 'High'
                                    : route.average_occupancy_30d && route.average_occupancy_30d > 60
                                        ? 'Medium'
                                        : 'Low'}
                            </Text>
                        </View>
            ...
            {route.status !== 'active' && (
                <View style={styles.warningContainer}>
                    ...
                    <Text style={styles.warningText}>
                        This route is currently {route.status}. No trips can be scheduled until it's activated.
                    </Text>
                </View>
            )}
        </ScrollView>
