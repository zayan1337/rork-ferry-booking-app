...
const FAQCategoryForm: React.FC<FAQCategoryFormProps> = ({
  ...
  useEffect(() => {
    if (!isEditing && formData.order_index === 0) {
      ...
      setFormData((prev: FAQCategoryFormData) => ({
        ...prev,
        ...
        >
          ...
          <View style={styles.section}>
            ...
            <View style={styles.formGroup}>
              ...
              />
              <Text style={styles.helperText}>
                Optional. Maximum 500 characters. Current:{' '}
          ...
          <View style={styles.infoCard}>
            ...
            <Text style={styles.infoText}>
              Categories help organize your FAQs and make them easier for users
              to find. Choose clear, descriptive names that represent the type
