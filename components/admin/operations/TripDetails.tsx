...
const getTripStatus = (travelDate: string, departureTime: string, arrivalTime?: string) => {
    const now = new Date();
...
export default function TripDetails({
    ...
    const occupancyPercentage = calculateOccupancy(trip.booked_seats || 0, trip.available_seats || 0);
    const currentStatus = getTripStatus(trip.travel_date, trip.departure_time, trip.arrival_time);

    // Calculate revenue based on booked seats and fare
    const baseRoute = trip.route;
    const estimatedRevenue = (trip.booked_seats || 0) * (baseRoute?.base_fare || 0) * (trip.fare_multiplier || 1);
    ...
    const stats = [
        ...
        {
            title: 'Duration',
            value: trip.estimated_duration || formatTripDuration(trip.departure_time, trip.arrival_time),
    ...
    const canCancel = trip.status === 'scheduled' && new Date(trip.travel_date) > new Date();
        ...
        >
            ...
            <View style={styles.header}>
                <View style={styles.headerContent}>
                    ...
                    <Text style={styles.subtitle}>{trip.route?.origin} → {trip.route?.destination}</Text>
                    <View style={styles.statusContainer}>
                        <StatusBadge
                            status={getCompatibleStatus(trip.status)}
                        />
                ...
                <View style={styles.infoGrid}>
                    ...
                    <View style={styles.infoItem}>
                        ...
                        <View style={styles.infoContent}>
                            ...
                            <Text style={styles.infoValue}>{formatTripTime(trip.departure_time)}</Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.infoItem}>
                        ...
                        <View style={styles.infoContent}>
                            ...
                            <Text style={styles.infoValue}>{trip.arrival_time ? formatTripTime(trip.arrival_time) : 'TBD'}</Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.infoItem}>
                        ...
                        <View style={styles.infoContent}>
                            ...
                            <Text style={styles.infoValue}>{trip.vesselName || trip.vessel?.name}</Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.infoItem}>
                        ...
                        <View style={styles.infoContent}>
                            ...
                            <Text style={styles.infoValue}>{trip.routeName || trip.route?.name}</Text>
                        </View>
                    </View>
