...
const FAQForm: React.FC<FAQFormProps> = ({
  ...
  const handleFieldChange = (field: keyof FAQFormData, value: any) => {
    setFormData((prev: FAQFormData) => ({ ...prev, [field]: value }));
        ...
        >
                  ...
                  <View style={styles.categoryDescriptionContent}>
                    ...
                    <Text style={styles.categoryDescriptionText}>
                      {selectedCategory.description ||
                        'FAQ category for organizing related questions'}
                    </Text>
                  </View>
                </View>
              )}
          ...
          <View style={styles.infoCard}>
            ...
            <Text style={styles.infoText}>
              FAQs are displayed to users based on their category and order
              index. Make sure to provide clear, helpful answers that address
              common questions.
            </Text>
          </View>
        </ScrollView>
