...
export default function ScheduleManager({
    ...
    const stats = useMemo(() => {
        ...
        const averageOccupancy = filteredTrips.reduce((sum, trip) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.statsContainer}>
                ...
                <View style={styles.statItem}>
                    <Text style={styles.statValue}>{stats.averageOccupancy.toFixed(1)}%</Text>
            ...
            <View style={styles.controlsContainer}>
                ...
                <View style={styles.viewControls}>
                    ...
                    >
                        <List size={16} color={viewMode === 'list' ? colors.primary : colors.textSecondary} />
                    </TouchableOpacity>
                    <TouchableOpacity
                ...
                <View style={styles.actionButtons}>
                    <TouchableOpacity style={styles.actionButton} onPress={handleOptimizeSchedule}>
                        <Zap size={16} color={colors.primary} />
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.actionButton} onPress={onBulkSchedule}>
                        <Upload size={16} color={colors.primary} />
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.actionButton} onPress={onExportSchedule}>
