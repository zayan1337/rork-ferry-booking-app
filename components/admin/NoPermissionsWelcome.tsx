...
export default function NoPermissionsWelcome({
    ...
    const displayRole = adminRole || user?.profile?.role || 'System Administrator';
    ...
    const getPermissionSuggestions = () => {
        ...
        if (displayRole.toLowerCase().includes('customer service') || displayRole.toLowerCase().includes('support')) {
            suggestions.push(
                {
        ...
        } else if (displayRole.toLowerCase().includes('operations') || displayRole.toLowerCase().includes('manager')) {
            suggestions.push(
                {
        ...
        } else if (displayRole.toLowerCase().includes('finance') || displayRole.toLowerCase().includes('accounting')) {
            suggestions.push(
                {
            ...
            >
                ...
                <View style={styles.mainCard}>
                    ...
                    <Text style={styles.title}>
                        {isSuperAdmin ? "Welcome, Super Administrator!" : `Welcome, ${displayName}!`}
                    </Text>
                    ...
                    <View style={styles.permissionsGrid}>
                        {suggestions.map((suggestion, index) => (
                            <View key={index} style={styles.permissionCard}>
                                <View style={[styles.permissionIcon, { backgroundColor: suggestion.color + '15' }]}>
                ...
                <View style={styles.footer}>
                    <Text style={styles.footerText}>Ferry Booking System • Admin Panel</Text>
                </View>
            </ScrollView>
        </View>
    );
