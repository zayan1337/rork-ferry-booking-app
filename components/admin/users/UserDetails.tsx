...
export default function UserDetails({
    ...
    const activityLevelData = formatActivityLevel(user.statistics?.activity_level || 0);
    const engagementScoreData = formatEngagementScore(user.statistics?.engagement_score || 0);
    ...
    const stats = [
        {
            ...
            trend: user.statistics?.total_bookings && user.statistics.total_bookings > 0 ? '+' : '',
        },
        {
            title: 'Total Spent',
            ...
            trend: user.statistics?.total_spent && user.statistics.total_spent > 0 ? '+' : '',
        },
        {
            ...
            trend: user.statistics?.activity_level && user.statistics.activity_level > 50 ? '+' : '',
        },
        {
            title: 'Engagement',
            ...
            trend: user.statistics?.engagement_score && user.statistics.engagement_score > 70 ? '+' : '',
        },
    ];
                ...
                <View style={styles.infoGrid}>
                    ...
                    <View style={styles.infoItem}>
                        ...
                        <View style={styles.infoContent}>
                            ...
                            <Text style={styles.infoValue}>{user.mobile_number || 'Not provided'}</Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.contactGrid}>
                        <View style={styles.contactItem}>
                            ...
                            <View style={styles.contactContent}>
                                ...
                                <Text style={styles.contactValue}>{user.emergency_contact.name}</Text>
                            </View>
                        </View>
                        ...
                        <View style={styles.contactItem}>
                            ...
                            <View style={styles.contactContent}>
                                ...
                                <Text style={styles.contactValue}>{user.emergency_contact.phone}</Text>
                            </View>
                        </View>
                        ...
                        <View style={styles.contactItem}>
                            ...
                            <View style={styles.contactContent}>
                                ...
                                <Text style={styles.contactValue}>{user.emergency_contact.relationship}</Text>
                            </View>
                        </View>
                    </View>
                </View>
                    ...
                    <View style={styles.preferencesContainer}>
                        <View style={styles.preferenceItem}>
                            ...
                            <View style={[
                                ...
                                user.preferences.email_notifications && styles.preferenceEnabled
                            ]}>
                                <Text style={[
                                    styles.preferenceText,
                                    user.preferences.email_notifications && styles.preferenceTextEnabled
                                ]}>
                        ...
                        <View style={styles.preferenceItem}>
                            ...
                            <View style={[
                                styles.preferenceIndicator,
                                user.preferences.sms_notifications && styles.preferenceEnabled
                            ]}>
                                <Text style={[
                                    styles.preferenceText,
                                    user.preferences.sms_notifications && styles.preferenceTextEnabled
                                ]}>
            ...
            {user.status === 'suspended' && (
                <View style={styles.warningContainer}>
                    ...
                    <Text style={styles.warningText}>
                        This user account is suspended. They cannot access the system until reactivated.
                    </Text>
                </View>
            )}
            ...
            {user.status === 'inactive' && (
                <View style={styles.infoContainer}>
                    ...
                    <Text style={styles.infoText}>
                        This user account is inactive. They may have limited access to features.
                    </Text>
                </View>
            )}
        </ScrollView>
