...
export default function RouteItem({ route, onPress, showStats = true }: RouteItemProps) {
                ...
                {showStats && (
                    <View style={styles.statsContainer}>
                        <View style={styles.statsRow}>
                            {route.total_trips_30d !== null && route.total_trips_30d !== undefined && (
                                <View style={styles.statItem}>
                                    ...
                                    <View style={styles.statContent}>
                                        <Text style={styles.statValue}>{route.total_trips_30d}</Text>
                                        <Text style={styles.statLabel}>Trips</Text>
                                    </View>
                                </View>
                            )}

                            {route.total_bookings_30d !== null && route.total_bookings_30d !== undefined && (
                                <View style={styles.statItem}>
                                    <View style={[styles.statIcon, { backgroundColor: colors.info + '15' }]}>
                                        <Users size={12} color={colors.info} />
                                    </View>
                                    <View style={styles.statContent}>
                                        <Text style={styles.statValue}>{route.total_bookings_30d}</Text>
                                        <Text style={styles.statLabel}>Bookings</Text>
                                    </View>
                                </View>
                            )}

                            {route.total_revenue_30d !== null && route.total_revenue_30d !== undefined && (
                                <View style={styles.statItem}>
                            ...
                            {route.avg_occupancy_30d !== null && route.avg_occupancy_30d !== undefined && (
                                <View style={styles.statItem}>
                                    <View style={[
                                        styles.statIcon,
                                        { backgroundColor: getOccupancyColor(route.avg_occupancy_30d) + '15' }
                                    ]}>
                                        <Activity size={12} color={getOccupancyColor(route.avg_occupancy_30d)} />
                                    </View>
                                    <View style={styles.statContent}>
                                        <Text style={styles.statValue}>{route.avg_occupancy_30d.toFixed(0)}%</Text>
