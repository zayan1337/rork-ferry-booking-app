                    ...
                    <View style={styles.modalContent}>
                        ...
                        <View style={styles.yearMonthSelector}>
                                            ...
                                            {yearOptions.map((year) => (
                                                <TouchableOpacity
                                                    ...
                                                    style={[
                                                        ...
                                                        currentYear === year && styles.dropdownOptionSelected
                                                    ]}
                                                    onPress={() => handleYearChange(year)}
                                                >
                                                    <Text style={[
                                                        styles.dropdownOptionText,
                                                        currentYear === year && styles.dropdownOptionTextSelected
                                                    ]}>
                                                        {year}
                                                    </Text>
                                                </TouchableOpacity>
                            ...
                            <View style={styles.selectorContainer}>
                                ...
                                >
                                    <Text style={styles.selectorButtonText}>{monthNames[currentMonth]}</Text>
                                    <ChevronDown
                                        size={16}
                                        color={colors.textSecondary}
                                        style={[
                                        ...
                                        >
                                            {monthNames.map((month, index) => (
                                                <TouchableOpacity
                                                    ...
                                                    style={[
                                                        styles.dropdownOption,
                                                        currentMonth === index && styles.dropdownOptionSelected
                                                    ]}
                                                    onPress={() => handleMonthChange(index)}
                                                >
                                                    <Text style={[
                                                        styles.dropdownOptionText,
                                                        currentMonth === index && styles.dropdownOptionTextSelected
                                                    ]}>
                                                        {month}
                                                    </Text>
                                                </TouchableOpacity>
